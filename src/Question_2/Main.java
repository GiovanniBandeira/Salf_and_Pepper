...
public class Main {
    ...
    public static void processImage(Path imagePath, Path NewImagePath3, Path NewImagePath5, Path NewImagePath7, Path NewImagePath9) throws IOException {
        ...
        // Matriz 7x7
        double[][] Filter7x7 = {
                {0.0625,   1,    1, 0.125,    1,   1, 0.0625},
                {0.125,    0,    0,  0.25,    0,   0,  0.125},
                {0.0625,   0, 0.25,  0.25, 0.25,   0, 0.0625},
                {0.125, 0.25, 0.25,  0.25, 0.25, 0.25, 0.125},
                {0.0625,   0, 0.25,  0.25, 0.25,   0, 0.0625},
                {0.125,    0,    0,  0.25,    0,   0,  0.125},
                {0.0625,   1,  0.1, 0.125,    1,   1, 0.0625}
        };

        // Matriz 9x9
        double[][] Filter9x9 = {
                {0.0625, 0.125, 0.0625, 0.125, 0.0625, 0.125, 0.0625, 0.125, 0.0625},
                {0.125,      0,      0,     0,   0.25,     0,      0,     0,  0.125},
                {0.0625,     0,      0,  0.25,   0.25,  0.25,      0,     0, 0.0625},
                {0.125,      0,   0.25,  0.25,   0.25,  0.25,   0.25,     0,  0.125},
                {0.0625,  0.25,   0.25,  0.25,   0.25,  0.25,   0.25,  0.25, 0.0625},
                {0.125,      0,   0.25,  0.25,   0.25,  0.25,   0.25,     0,  0.125},
                {0.0625,     0,      0,  0.25,   0.25,  0.25,      0,     0, 0.0625},
                {0.125,      0,      0,     0,   0.25,     0,      0,     0,  0.125},
                {0.0625, 0.125, 0.0625, 0.125, 0.0625, 0.125, 0.0625, 0.125, 0.0625}
